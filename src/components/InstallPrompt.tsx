...
export default function InstallPrompt() {
  ...
  const modalContent = showModal ? (
    <div className="install-modal-overlay" onClick={() => setShowModal(false)} role="dialog" aria-modal="true">
                ...
                <li className="step-item">
                  ...
                  <div className="step-content">
                    ...
                    <div className="step-visual">
                      <Share size={16} className="text-accent" /> <span>Share Button</span>
                    </div>
                  </div>
                </li>
                <li className="step-item">
                  ...
                  <div className="step-content">
                    ...
                    <div className="step-visual">
                      <PlusSquare size={16} className="text-accent" /> <span>Add to Home Screen</span>
                    </div>
                  </div>
                </li>
                <li className="step-item">
              ...
              <ol className="steps-list">
                ...
                <li className="step-item">
                  ...
                  <div className="step-content">
                    ...
                    <div className="step-visual">
                      <Download size={16} className="text-accent" /> <span>Install App</span>
                    </div>
                  </div>
                </li>
              </ol>
  ...
  return (
    <>
      ...
      {/* Instructional Modal rendered via Portal */}
